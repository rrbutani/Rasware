...
int main(void)
{
    ...
    while(1)
    {
      ...
      if(lS && rS)
      {
        //Then, we're on the line and we're happy.
        driveForward();
        setColor(2);
      }
      else if(lS)
      {
        //Keep left wheel still, move right wheel forward.
        SetMotor(Motors[0], -0.1f);
        SetMotor(Motors[1], -0.1f);
        setColor(1);
      }
      ...
      {
        //Keep right wheel still, move left wheel forward.
        SetMotor(Motors[0], 0.1f);
        SetMotor(Motors[1], 0.1f);
        setColor(3);
      }
